    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-{!! $localSide !!} image">
            <img src="https://placehold.it/160x160/00a65a/ffffff/&text={{ mb_substr(Auth::user()->name, 0, 1) }}" class="img-circle" alt="User Image">
          </div>
          <div class="pull-{!! $localSide !!} info">
            <p>{{ Auth::user()->name }}</p>
        ...
        <li class="treeview">
            <a href="#"><i class="fa fa-wrench"></i> <span>{{ trans('backpack::base.administration') }}</span> <i class="fa fa-angle-{!! $localSide !!} pull-{!! $localSide !!}"></i></a>
            <ul class="treeview-menu">
             {{--  <li class="header">{{ trans('backpack::base.administration') }}</li> --}}
              ...
              <li class="treeview">
                <a href="#"><i class="fa fa-globe"></i> <span>Translations</span> <i class="fa fa-angle-{!! $localSide !!} pull-{!! $localSide !!}"></i></a>
                <ul class="treeview-menu">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-group"></i> <span>Users, Roles, Permissions</span> <i class="fa fa-angle-{!! $localSide !!} pull-{!! $localSide !!}"></i></a>
            <ul class="treeview-menu">
